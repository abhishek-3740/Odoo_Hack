    ...
    @Query("""
            select coalesce(sum(r.quantity), 0)
             ...
             where r.orderLineId = :orderLineId
               and r.status = com.dealflow.fulfillment.models.Reservation.ReservationStatus.CONSUMED
            """)
    ...
    @Query("""
            select r from Reservation r
             where r.orderId = :orderId
               and r.status = com.dealflow.fulfillment.models.Reservation.ReservationStatus.HELD
            """)

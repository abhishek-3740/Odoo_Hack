...
public interface BackorderRepository extends JpaRepository<Backorder, UUID> {
    ...
    @Query("""
            select b from Backorder b
             where b.orderId = :orderId
               and b.status = com.dealflow.fulfillment.models.Backorder.BackorderStatus.OPEN
            """)
    ...
    @Query("""
            select b from Backorder b
             where b.status = com.dealflow.fulfillment.models.Backorder.BackorderStatus.OPEN
            """)
